...
decisions" is theirs; an agent implements one the owner has recorded (root §1)
and stops.
...
implement the one they recorded. Two constraints from the
...
propose answers; implement the decision the owner recorded:
